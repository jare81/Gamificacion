...
spriteV::spriteV(QObject *parent)
    : QObject(parent), isSprite()
{
    timer = new QTimer(this);
    connect(timer, &QTimer::timeout, this, &spriteV::actualizacion);

    // Carga de hojas (ajusta rutas)
    pixmapIdle  = new QPixmap("C:/Users/Dell/Documents/Documentos/PROYECTO/Gamificacion/images/normalV.png");
    pixmapLeft  = new QPixmap("C:/Users/Dell/Documents/Documentos/PROYECTO/Gamificacion/images/caminarVI.png"); // izquierda
    pixmapRight = new QPixmap("C:/Users/Dell/Documents/Documentos/PROYECTO/Gamificacion/images/caminarVD.png"); // derecha
    pixmapAtk   = new QPixmap("C:/Users/Dell/Documents/Documentos/PROYECTO/Gamificacion/images/ataqueV.png");
    pixmapHurt  = new QPixmap("C:/Users/Dell/Documents/Documentos/PROYECTO/Gamificacion/images/dolorV.png");
...
// QRectF spriteV::boundingRect() const
// {
//     switch (estado) {
//     case Estado::Attack: return QRectF(-wAtk/2,  -hAtk/2,  wAtk,  hAtk);
//     case Estado::Hurt:   return QRectF(-wHurt/2, -hHurt/2, wHurt, hHurt);
//     case Estado::WalkLeft:
//     case Estado::WalkRight: return QRectF(-wWalk/2, -hWalk/2, wWalk, hWalk);
//     case Estado::Idle:
//     default:            return QRectF(-wIdle/2, -hIdle/2, wIdle, hIdle);
//     }
// }
...
void spriteV::paint(QPainter *p, const QStyleOptionGraphicsItem*, QWidget*)
{
...
QSizeF spriteV::sizeFor(Estado e) const {
    switch (e) {
...
void spriteV::setEstado(Estado e)
{
...
void spriteV::ajustarTickPorEstado() {
    if (!timer) return;
...
void spriteV::seleccionarPixmapPorEstado()
{
    switch (estado) {
...
int spriteV::frameWidthActual() const
{
    switch (estado) {
...
int spriteV::frameHeightActual() const
{
    switch (estado) {
...
int spriteV::framesTotalesActual() const
{
    switch (estado) {
...
void spriteV::mover(int dx, int dy)
{
...
bool spriteV::estaEnZona(const QString &nombreZona) const {
    Q_UNUSED(nombreZona);
    return false; // o puedes copiar la lógica de colisiones si te sirve
}

void spriteV::quietoForce()
{
